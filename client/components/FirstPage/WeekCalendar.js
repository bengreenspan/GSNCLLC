              ...
              <div className="fontbold">
                ...
                <div className="date">
                  <div className="links">
                    ...
                    >
                      <h2>
                        Technology Pioneers Series: Fireside Chat with Alan
                        Patricof
                      </h2>
                    </a>
                  </div>
                ...
                <div className="date">
                  <div className="links">
                    ...
                    >
                      <h2>
                        Lenapehoking: On Indigenous Epistemologies and the Idea
                        of the University
                      </h2>
                    </a>
                  </div>
                  {/* <h4>20 person limit</h4> */}
                  <h4>
                    Allan Rosenfield Building, 722 West 168th St. 3:30pm-5:00pm{" "}
                  </h4>
                </div>
                <br />
                <div className="date">
                ...
                <div className="links">
                  <div className="date">
                    ...
                    >
                      <h2>
                        Distinguished Speaker Series with Matthew Lustig: Real
                        Estate IB, Lazard
                      </h2>
                    </a>
                ...
                <div className="date">
                  <div className="links">
                    ...
                    >
                      <h2>
                        CU there! Presents: The Art and Science of Networking{" "}
                      </h2>
                    </a>
                  </div>
                ...
                <div className="date">
                  <div className="links">
                    ...
                    >
                      <h2>
                        21st Annual Social Enterprise Conference, Capital for
                        Good, Tamer Institute
                      </h2>
                    </a>
